...
#defaults write NSGlobalDomain AppleLocale -string "sv@currency=SEK"
...
defaults write com.googlecode.iterm2.plist PrefsCustomFolder -string "~/dotfiles/templates/iterm2"
